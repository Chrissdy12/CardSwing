...
public class CardStatusBadgeBeanInfo extends SimpleBeanInfo {

    @Override
    public BeanDescriptor getBeanDescriptor() {
        BeanDescriptor bd = new BeanDescriptor(CardStatusBadge.class);
        bd.setDisplayName("CardStatusBadge");
        return bd;
    }
